...
class RequestVoteReceive:
    ...
    def __init__(self, request_vote_json_dict, raft_peer_state):
        ...
        self.candidate_id = request_vote_json_dict["candidate_id"]
    ...
    def process_request_vote(self):
        ...
        with RequestVoteReceive.lock:
            request_vote_result = {"send_to": list(self.send_from),
                                   "send_fro": list(self.raft_peer_state.my_addr_port_tuple),
